...
mod test {
    ...
    fn nesting_01() {
        ...
        let b = path_from_path_data("M 37.909023,24 A 13.909023,13.909023 0 0 1 24,37.909023 13.909023,13.909023 0 0 1 10.090978,24 13.909023,13.909023 0 0 1 24,10.090978 13.909023,13.909023 0 0 1 37.909023,24 Z");
        let union = path_boolean(
            &a,
            path_boolean::FillRule::NonZero,
            &b,
            path_boolean::FillRule::NonZero,
            path_boolean::PathBooleanOperation::Union,
        );
        dbg!(path_to_path_data(&union[0], 0.001));
    }
    #[test]
    fn nesting_02() {
        let a = path_from_path_data(
        "M 0.99999994,31.334457 C 122.61195,71.81859 -79.025816,-5.5803326 47,32.253367 V 46.999996 H 0.99999994 Z",
    );
        ...
        assert_eq!(
            result.len(),
            1,
            "Expected 1 resulting path for Union operation"
        );
