...
impl Bezier {
	...
	/// <iframe frameBorder="0" width="100%" height="360px" src="https://graphite.rs/bezier-rs-demos#bezier/constructor/solo" title="Constructor Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="360px" src="https://graphite.rs/bezier-rs-demos#bezier/bezier-through-points/solo" title="Through Points Demo"></iframe>
