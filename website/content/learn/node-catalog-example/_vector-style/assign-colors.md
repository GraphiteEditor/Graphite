...
|:-|:-|:-|
| Content | <p>The content with vector paths to apply the fill and/or stroke style to.</p><p><em>Primary Input</em></p> | `Table<Vector>`<br />`Table<Graphic>` |
...
|:-|:-|:-|
| Result | <p>The vector content with the fill and/or stroke styles applied.</p><p><em>Primary Output</em></p> | `Table<Vector>`<br />`Table<Graphic>` |
