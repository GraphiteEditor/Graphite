				...
				implementation: NodeTemplateImplementation::Network(NodeNetworkTemplate {
					...
					nodes: [
						...
						NodeTemplate {
							...
							implementation: NodeTemplateImplementation::ProtoNode(graphic::extract_element::IDENTIFIER),
						...
						NodeTemplate {
							inputs: vec![NodeInput::node(NodeId(0), 0), NodeInput::value(TaggedValue::F64(0.), false)],
							implementation: NodeTemplateImplementation::ProtoNode(graphic::omit_element::IDENTIFIER),
