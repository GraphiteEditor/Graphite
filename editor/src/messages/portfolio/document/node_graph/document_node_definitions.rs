				...
				implementation: NodeTemplateImplementation::Network(NodeNetworkTemplate {
					...
					nodes: [
						...
						NodeTemplate {
							...
							implementation: NodeTemplateImplementation::ProtoNode(graphic::stamp_layer_path::IDENTIFIER),
				...
				implementation: NodeTemplateImplementation::Network(NodeNetworkTemplate {
					...
					nodes: [
						...
						NodeTemplate {
							...
							implementation: NodeTemplateImplementation::ProtoNode(artboard::translate_footprint::IDENTIFIER),
			...
			node_template: NodeTemplate {
				implementation: NodeTemplateImplementation::Network(NodeNetworkTemplate {
					...
					nodes: [
						...
						// 5: Map
						NodeTemplate {
							implementation: NodeTemplateImplementation::ProtoNode(list::map::IDENTIFIER),
				...
				implementation: NodeTemplateImplementation::Network(NodeNetworkTemplate {
					...
					nodes: [
						...
						NodeTemplate {
							...
							implementation: NodeTemplateImplementation::ProtoNode(list::item_at_index::IDENTIFIER),
						...
						NodeTemplate {
							inputs: vec![NodeInput::node(NodeId(0), 0), NodeInput::value(TaggedValue::F64(0.), false)],
							implementation: NodeTemplateImplementation::ProtoNode(list::remove_at_index::IDENTIFIER),
...
mod test_type_constraints {
	...
	fn test_node_accept_f32_f64_dvec2<T: std::any::Any>(_: impl Ctx, #[implementations(f32, f64, DVec2)] a: T, _b: bool) -> T {
		a
	}
	...
	#[node_macro::node(category(""))]
	fn test_node_accept_f32_f64_string<T: std::any::Any>(_: impl Ctx, #[implementations(f32, f64, String)] a: T, _b: bool) -> T {
		a
	}
