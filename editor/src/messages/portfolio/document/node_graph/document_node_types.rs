	...
	vec![
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				...
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["Canvas".to_string()],
					output_names: vec!["Image Frame".to_string()],
					network_metadata: Some(NodeNetworkMetadata {
						persistent_metadata: NodeNetworkPersistentMetadata {
							node_metadata: [
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				...
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["In".to_string()],
					output_names: vec!["Scope".to_string(), "Binding".to_string()],
					network_metadata: Some(NodeNetworkMetadata {
						persistent_metadata: NodeNetworkPersistentMetadata {
							node_metadata: [
								DocumentNodeMetadata {
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				...
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["Scope".to_string(), "Data".to_string()],
					output_names: vec!["Frame".to_string()],
					..Default::default()
				},
			},
			category: "Ignore",
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![
						...
						NodeInput::value(TaggedValue::NoiseType(NoiseType::Perlin), false),
						NodeInput::value(TaggedValue::DomainWarpType(DomainWarpType::None), false),
						NodeInput::value(TaggedValue::F64(100.), false),
						NodeInput::value(TaggedValue::FractalType(FractalType::None), false),
						...
						NodeInput::value(TaggedValue::F64(2.), false),
						NodeInput::value(TaggedValue::CellularDistanceFunction(CellularDistanceFunction::Euclidean), false),
						NodeInput::value(TaggedValue::CellularReturnType(CellularReturnType::Nearest), false),
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![
						NodeInput::value(TaggedValue::ImageFrame(ImageFrame::empty()), true),
						NodeInput::value(TaggedValue::ImageFrame(ImageFrame::empty()), true),
						NodeInput::value(TaggedValue::RedGreenBlue(RedGreenBlue::Red), false),
					],
					..Default::default()
				},
				persistent_node_metadata: DocumentNodePersistentMetadata {
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					implementation: DocumentNodeImplementation::proto("graphene_core::ops::IdentityNode"),
					inputs: vec![NodeInput::value(TaggedValue::BlendMode(BlendMode::Normal), false)],
					..Default::default()
				},
				persistent_node_metadata: DocumentNodePersistentMetadata {
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![NodeInput::value(TaggedValue::F64(0.), true), NodeInput::network(concrete!(WasmEditorApi), 0)],
					..Default::default()
				},
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["In".to_string(), "In".to_string()],
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![NodeInput::value(TaggedValue::None, true), NodeInput::network(concrete!(WasmEditorApi), 0)],
					..Default::default()
				},
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["In".to_string(), "In".to_string()],
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![
						NodeInput::network(concrete!(<WgpuExecutor as GpuExecutor>::ShaderHandle), 0),
						NodeInput::network(concrete!(String), 1),
						NodeInput::network(concrete!(gpu_executor::Bindgroup<WgpuExecutor>), 2),
						NodeInput::network(concrete!(Arc<ShaderInput<WgpuExecutor>>), 3),
					],
					..Default::default()
				},
				persistent_node_metadata: DocumentNodePersistentMetadata {
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				...
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["Image".to_string(), "Node".to_string(), "In".to_string()],
					output_names: vec!["Image".to_string()],
					..Default::default()
				},
			},
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![
						NodeInput::Value(TaggedValue::ImageFrame(ImageFrame::empty()), true),
						// Mode
						NodeInput::Value(TaggedValue::RelativeAbsolute(RelativeAbsolute::Relative), false),
						// Reds
						NodeInput::Value(TaggedValue::F64(0.), false),
						NodeInput::Value(TaggedValue::F64(0.), false),
						NodeInput::Value(TaggedValue::F64(0.), false),
						...
						NodeInput::Value(TaggedValue::F64(0.), false),
						// Display-only properties (not used within the node)
						NodeInput::Value(TaggedValue::SelectiveColorChoice(SelectiveColorChoice::Reds), false),
					],
					..Default::default()
				},
				persistent_node_metadata: DocumentNodePersistentMetadata {
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![
						NodeInput::value(TaggedValue::None, false),
						NodeInput::value(TaggedValue::Subpaths(vec![]), false),
						NodeInput::value(TaggedValue::ManipulatorGroupIds(vec![]), false),
					],
					..Default::default()
				},
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["None".to_string(), "Path Data".to_string(), "Colinear Manipulators".to_string()],
					output_names: vec!["Vector".to_string()],
					..Default::default()
				},
			},
		...
		DocumentNodeDefinition {
			...
			node_template: NodeTemplate {
				...
				persistent_node_metadata: DocumentNodePersistentMetadata {
					input_names: vec!["None".to_string(), "Text".to_string(), "Font".to_string(), "Size".to_string()],
					output_names: vec!["Vector".to_string()],
					..Default::default()
				},
			},
			...
			node_template: NodeTemplate {
				document_node: DocumentNode {
					...
					inputs: vec![
						...
						NodeInput::value(TaggedValue::F64(0.), false),
						NodeInput::value(TaggedValue::LineCap(graphene_core::vector::style::LineCap::Butt), false),
						NodeInput::value(TaggedValue::LineJoin(graphene_core::vector::style::LineJoin::Miter), false),
...
// 		[
// 			::network(concrete!(WasmEditorApi), 0),
