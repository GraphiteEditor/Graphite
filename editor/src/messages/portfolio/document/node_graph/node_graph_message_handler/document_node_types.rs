...
fn static_nodes() -> Vec<DocumentNodeType> {
	vec![
		...
		DocumentNodeType {
			name: "Transform",
			category: "Vector",
			identifier: NodeImplementation::proto("graphene_core::vector::TransformNode<_, _, _, _, _>"),
			inputs: vec![
		...
		DocumentNodeType {
			...
			inputs: vec![
				...
				DocumentInputType::value("Solid Color", TaggedValue::Color(Color::TRANSPARENT), false),
