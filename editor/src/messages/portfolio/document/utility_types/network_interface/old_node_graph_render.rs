...
impl NodeNetworkInterface {
	...
	pub fn frontend_output_from_connector_old(&mut self, output_connector: &OutputConnector, network_path: &[NodeId]) -> Option<FrontendGraphOutput> {
	...
	pub fn unload_import_export_ports_old(&mut self, network_path: &[NodeId]) {
