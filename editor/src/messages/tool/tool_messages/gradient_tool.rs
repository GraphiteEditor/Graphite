...
impl SelectedGradient {
	...
	pub fn update_gradient(&mut self, mouse: DVec2, responses: &mut VecDeque<Message>, snap_rotate: bool, gradient_type: GradientType, drag_start: DVec2, mouse_offset: DVec2) {
