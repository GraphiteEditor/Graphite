...
pub fn get_text(layer: LayerNodeIdentifier, network_interface: &NodeNetworkInterface) -> Option<(&String, &Font, f64, f64, f64, f64)> {
	...
	let Some(&TaggedValue::F64(line_width)) = inputs[6].as_value() else { return None };
