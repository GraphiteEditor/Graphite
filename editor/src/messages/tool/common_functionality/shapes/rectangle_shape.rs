...
use crate::messages::portfolio::document::node_graph::document_node_definitions::{resolve_document_node_type, DefinitionIdentifier};
...
impl Rectangle {
	pub fn create_node() -> NodeTemplate {
		let node_type = resolve_document_node_type(&DefinitionIdentifier::ProtoNode(graphene_std::vector::generator_nodes::rectangle::IDENTIFIER)).expect("Rectangle node can't be found");
