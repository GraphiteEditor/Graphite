...
impl Circle {
	pub fn create_node() -> NodeTemplate {
		let node_type = resolve_document_node_type(&DefinitionIdentifier::ProtoNode(graphene_std::vector::generator_nodes::circle::IDENTIFIER)).expect("Circle can't be found");
