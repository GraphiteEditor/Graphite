...
impl Ellipse {
	pub fn create_node() -> NodeTemplate {
		let node_type = resolve_document_node_type(&DefinitionIdentifier::ProtoNode(graphene_std::vector::generator_nodes::ellipse::IDENTIFIER)).expect("Ellipse node can't be found");
