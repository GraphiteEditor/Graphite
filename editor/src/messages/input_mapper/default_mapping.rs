...
pub fn default_mapping() -> Mapping {
	...
	let mappings = mapping![
		...
		entry!(KeyDown(ArrowRight); modifiers=[Alt], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: 0., is_bottom_right: true }),
		entry!(KeyDown(ArrowRight); modifiers=[Alt, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowRight); modifiers=[Alt, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: 0., is_bottom_right: true }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, is_bottom_right: true }),
		...
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: 0., is_bottom_right: true }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Shift, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Shift, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Shift, ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Shift, ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowUp); modifiers=[Alt, Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowUp); modifiers=[Alt, Shift, ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowUp); modifiers=[Alt, Shift, ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		entry!(KeyDown(ArrowUp); modifiers=[Alt, Shift, ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: true }),
		// alt+ctrl+arrow key to resize the top/left edges
		entry!(KeyDown(ArrowRight); modifiers=[Alt, Control], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: 0., is_bottom_right: false }),
		entry!(KeyDown(ArrowRight); modifiers=[Alt, Control, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowRight); modifiers=[Alt, Control, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Control], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: 0., is_bottom_right: false }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Control, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Control, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Control], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: -NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Control, ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Control, ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, is_bottom_right: false }),
		...
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Control, Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: 0., is_bottom_right: false }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Control, Shift, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowLeft); modifiers=[Alt, Control, Shift, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Control, Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Control, Shift, ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowDown); modifiers=[Alt, Control, Shift, ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, is_bottom_right: false }),
		entry!(KeyDown(ArrowUp); modifiers=[Alt, Control, Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: BIG_NUDGE_AMOUNT, is_bottom_right: false }),
