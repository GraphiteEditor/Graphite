...
pub fn default_mapping() -> Mapping {
	...
	let mappings = mapping![
		...
		entry!(KeyDown(ArrowDown); modifiers=[Shift, ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowDown); modifiers=[Shift, ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowDown); modifiers=[Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: BIG_NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowLeft); modifiers=[Shift, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowLeft); modifiers=[Shift, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowLeft); modifiers=[Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -BIG_NUDGE_AMOUNT, delta_y: 0., alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowRight); modifiers=[Shift, ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: -BIG_NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowRight); modifiers=[Shift, ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: BIG_NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowRight); modifiers=[Shift], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: BIG_NUDGE_AMOUNT, delta_y: 0., alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowUp); modifiers=[ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowUp); modifiers=[ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowUp); action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: -NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowDown); modifiers=[ArrowLeft], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowDown); modifiers=[ArrowRight], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowDown); action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: 0., delta_y: NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowLeft); modifiers=[ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowLeft); modifiers=[ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowLeft); action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: -NUDGE_AMOUNT, delta_y: 0., alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowRight); modifiers=[ArrowUp], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: -NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
		entry!(KeyDown(ArrowRight); modifiers=[ArrowDown], action_dispatch=DocumentMessage::NudgeResizeSelectedLayer { delta_x: NUDGE_AMOUNT, delta_y: NUDGE_AMOUNT, alt: Alt, ctrl: Control }),
