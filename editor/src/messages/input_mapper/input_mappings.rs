...
pub fn input_mappings() -> Mapping {
	...
	let mappings = mapping![
		...
		entry!(KeyDownNoRepeat(KeyX); action_dispatch=TransformLayerMessage::ConstrainX),
		entry!(KeyDownNoRepeat(KeyY); action_dispatch=TransformLayerMessage::ConstrainY),
		...
		entry!(KeyDownNoRepeat(KeyG); action_dispatch=PathToolMessage::GRS { key: KeyG }),
		entry!(KeyDownNoRepeat(KeyR); action_dispatch=PathToolMessage::GRS { key: KeyR }),
		entry!(KeyDownNoRepeat(KeyS); action_dispatch=PathToolMessage::GRS { key: KeyS }),
		...
		//
		// ToolMessage
		entry!(KeyDownNoRepeat(KeyV); action_dispatch=ToolMessage::ActivateToolSelect),
		entry!(KeyDownNoRepeat(KeyZ); action_dispatch=ToolMessage::ActivateToolNavigate),
		entry!(KeyDownNoRepeat(KeyI); action_dispatch=ToolMessage::ActivateToolEyedropper),
		entry!(KeyDownNoRepeat(KeyT); action_dispatch=ToolMessage::ActivateToolText),
		entry!(KeyDownNoRepeat(KeyF); action_dispatch=ToolMessage::ActivateToolFill),
		entry!(KeyDownNoRepeat(KeyH); action_dispatch=ToolMessage::ActivateToolGradient),
		entry!(KeyDownNoRepeat(KeyA); action_dispatch=ToolMessage::ActivateToolPath),
		entry!(KeyDownNoRepeat(KeyP); action_dispatch=ToolMessage::ActivateToolPen),
		entry!(KeyDownNoRepeat(KeyN); action_dispatch=ToolMessage::ActivateToolFreehand),
		entry!(KeyDownNoRepeat(KeyL); action_dispatch=ToolMessage::ActivateToolLine),
		entry!(KeyDownNoRepeat(KeyM); action_dispatch=ToolMessage::ActivateToolRectangle),
		entry!(KeyDownNoRepeat(KeyE); action_dispatch=ToolMessage::ActivateToolEllipse),
		entry!(KeyDownNoRepeat(KeyY); action_dispatch=ToolMessage::ActivateToolPolygon),
		entry!(KeyDownNoRepeat(KeyB); action_dispatch=ToolMessage::ActivateToolBrush),
		...
		//
		// DocumentMessage
		entry!(KeyDownNoRepeat(Space); modifiers=[Control], action_dispatch=DocumentMessage::GraphViewOverlayToggle),
		...
		entry!(KeyDownNoRepeat(KeyO); modifiers=[Alt], action_dispatch=DocumentMessage::ToggleOverlaysVisibility),
		entry!(KeyDownNoRepeat(KeyS); modifiers=[Alt], action_dispatch=DocumentMessage::ToggleSnapping),
		entry!(KeyDown(KeyH); modifiers=[Accel], action_dispatch=DocumentMessage::ToggleSelectedVisibility),
		entry!(KeyDownNoRepeat(KeyL); modifiers=[Accel], action_dispatch=DocumentMessage::ToggleSelectedLocked),
		entry!(KeyDownNoRepeat(KeyG); modifiers=[Alt], action_dispatch=DocumentMessage::ToggleGridVisibility),
		...
		//
		// TransformLayerMessage
		entry!(KeyDownNoRepeat(KeyG); action_dispatch=TransformLayerMessage::BeginGrab),
		entry!(KeyDownNoRepeat(KeyR); action_dispatch=TransformLayerMessage::BeginRotate),
		entry!(KeyDownNoRepeat(KeyS); action_dispatch=TransformLayerMessage::BeginScale),
		...
		entry!(KeyDownNoRepeat(KeyO); modifiers=[Accel], action_dispatch=PortfolioMessage::OpenDocument),
		entry!(KeyDownNoRepeat(KeyI); modifiers=[Accel], action_dispatch=PortfolioMessage::Import),
		...
		entry!(KeyDownNoRepeat(KeyR); modifiers=[Alt], action_dispatch=PortfolioMessage::ToggleRulers),
		//
		// FrontendMessage
		entry!(KeyDown(KeyV); modifiers=[Accel], action_dispatch=FrontendMessage::TriggerPaste),
		//
		// DialogMessage
		entry!(KeyDownNoRepeat(KeyE); modifiers=[Accel], action_dispatch=DialogMessage::RequestExportDialog),
		entry!(KeyDownNoRepeat(KeyN); modifiers=[Accel], action_dispatch=DialogMessage::RequestNewDocumentDialog),
		entry!(KeyDownNoRepeat(Comma); modifiers=[Accel], action_dispatch=DialogMessage::RequestPreferencesDialog),
		//
		// DebugMessage
