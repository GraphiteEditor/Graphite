...
pub fn input_mappings() -> Mapping {
	...
	let mappings = mapping![
		...
		entry!(KeyDown(KeyH); modifiers=[Control], action_dispatch=DocumentMessage::ToggleSelectedVisibility),
		entry!(KeyDown(KeyL); modifiers=[Control], action_dispatch=DocumentMessage::ToggleSelectedLocked),
