...
pub fn input_mappings() -> Mapping {
	...
	let mappings = mapping![
		...
		entry!(PointerMove; refresh_keys=[KeyC, Shift, Space], action_dispatch=PathToolMessage::PointerMove { toggle_colinear: KeyC, equidistant: Shift, move_anchor_and_handles: Space}),
