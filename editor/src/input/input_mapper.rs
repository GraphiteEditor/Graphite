...
impl Default for Mapping {
	fn default() -> Self {
		...
		let mappings = mapping![
			...
			entry! {action=MovementMessage::IncreaseCanvasZoom{centre_mouse: false}, key_down=KeyPlus, modifiers=[KeyControl]},
			entry! {action=MovementMessage::IncreaseCanvasZoom{centre_mouse: false}, key_down=KeyEquals, modifiers=[KeyControl]},
			entry! {action=MovementMessage::DecreaseCanvasZoom{centre_mouse: false}, key_down=KeyMinus, modifiers=[KeyControl]},
