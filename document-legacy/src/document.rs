...
use graphene_core::{concrete, generic, ProtoNodeType};
					...
					implementation: graph_craft::document::DocumentNodeImplementation::Network(NodeNetwork {
						...
						nodes: [
							...
							DocumentNode {
								...
								implementation: DocumentNodeImplementation::Unresolved(ProtoNodeType::new("graphene_std::wasm_application_io::RenderNode<_, _, _>")),
								..Default::default()
							},
						]
						.into_iter()
