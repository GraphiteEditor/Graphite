<script lang="ts" context="module">
  import Document from "$lib/components/panels/Document.svelte";
  import IconButton from "$lib/components/widgets/buttons/IconButton.svelte";
  import LayerTree from "$lib/components/panels/LayerTree.svelte";
  import NodeGraph from "$lib/components/panels/NodeGraph.svelte";
