<script lang="ts">
	import { type Color } from "$lib/wasm-communication/messages";
...
<LayoutCol class="swatch-pair">
	<LayoutRow class="primary swatch">
		...
		<ColorPicker bind:open={primaryOpen} color={primary} on:color={(color) => primaryColorChanged(color)} direction="Right" />
	</LayoutRow>
	<LayoutRow class="secondary swatch">
		...
		<ColorPicker bind:open={secondaryOpen} color={secondary} on:color={(color) => secondaryColorChanged(color)} direction="Right" />
	</LayoutRow>
</LayoutCol>
