...
pub mod memo {
	pub const IDENTIFIER: crate::ProtoNodeIdentifier = crate::ProtoNodeIdentifier::new("core_types::memo::MemoNode");
}
...
pub mod impure_memo {
	pub const IDENTIFIER: crate::ProtoNodeIdentifier = crate::ProtoNodeIdentifier::new("core_types::memo::ImpureMemoNode");
}
...
pub mod monitor {
	pub const IDENTIFIER: crate::ProtoNodeIdentifier = crate::ProtoNodeIdentifier::new("core_types::memo::MonitorNode");
}
