...
/// Adds together all the numbers in the input list, giving their total.
#[node_macro::node(category("Math: Numeric"))]
async fn sum(_: impl Ctx, values: List<f64>) -> Item<f64> {
	Item::new_from_element(values.iter_element_values().sum())
}

/// Averages all the numbers in the input list. An empty list gives 0.
#[node_macro::node(category("Math: Numeric"))]
async fn average(_: impl Ctx, values: List<f64>) -> Item<f64> {
...
#[node_macro::node(category("Math: Numeric"))]
async fn minimum(_: impl Ctx, values: List<f64>) -> Item<f64> {
...
#[node_macro::node(category("Math: Numeric"))]
async fn maximum(_: impl Ctx, values: List<f64>) -> Item<f64> {
	Item::new_from_element(values.iter_element_values().copied().reduce(f64::max).unwrap_or_default())
}

/// Outputs true if at least one value in the input list is true.
#[node_macro::node(category("Math: Logic"))]
async fn any(_: impl Ctx, values: List<bool>) -> Item<bool> {
...
#[node_macro::node(category("Math: Logic"))]
async fn all(_: impl Ctx, values: List<bool>) -> Item<bool> {
