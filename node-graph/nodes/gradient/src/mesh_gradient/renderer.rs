...
use crate::mesh_gradient::tessellator::{MeshVertex, Metadata};
...
impl Renderer {
	...
	pub(crate) fn render(&self, executor: &WgpuExecutor, texture_size: UVec2, vertices: &[MeshVertex], indices: &[u32], color_data: &[[f32; 4]], metadata: Metadata, debug: bool) -> Option<Texture> {
