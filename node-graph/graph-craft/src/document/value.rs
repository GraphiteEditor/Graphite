...
pub enum TaggedValue {
	...
	Artboards(graphene_core::Artboards),
...
impl Hash for TaggedValue {
	fn hash<H: std::hash::Hasher>(&self, state: &mut H) {
		...
		match self {
			...
			TaggedValue::None => todo!(),
			TaggedValue::String(_) => todo!(),
			TaggedValue::U32(_) => todo!(),
			TaggedValue::U64(_) => todo!(),
			TaggedValue::F32(_) => todo!(),
			TaggedValue::F64(_) => todo!(),
			TaggedValue::Bool(_) => todo!(),
			TaggedValue::UVec2(_) => todo!(),
			TaggedValue::DVec2(_) => todo!(),
			TaggedValue::OptionalDVec2(_) => todo!(),
			TaggedValue::DAffine2(_) => todo!(),
			TaggedValue::Image(_) => todo!(),
			TaggedValue::ImaginateCache(_) => todo!(),
			TaggedValue::ImageFrame(_) => todo!(),
			TaggedValue::Color(_) => todo!(),
			TaggedValue::Subpaths(_) => todo!(),
			TaggedValue::RcSubpath(_) => todo!(),
			TaggedValue::BlendMode(_) => todo!(),
			TaggedValue::LuminanceCalculation(_) => todo!(),
			TaggedValue::ImaginateSamplingMethod(_) => todo!(),
			TaggedValue::ImaginateMaskStartingFill(_) => todo!(),
			TaggedValue::ImaginateController(_) => todo!(),
			TaggedValue::VectorData(_) => todo!(),
			TaggedValue::Fill(_) => todo!(),
			TaggedValue::Stroke(_) => todo!(),
			TaggedValue::VecF64(_) => todo!(),
			TaggedValue::VecDVec2(_) => todo!(),
			TaggedValue::RedGreenBlue(_) => todo!(),
			TaggedValue::NoiseType(_) => todo!(),
			TaggedValue::FractalType(_) => todo!(),
			TaggedValue::CellularDistanceFunction(_) => todo!(),
			TaggedValue::CellularReturnType(_) => todo!(),
			TaggedValue::DomainWarpType(_) => todo!(),
			TaggedValue::RelativeAbsolute(_) => todo!(),
			TaggedValue::SelectiveColorChoice(_) => todo!(),
			TaggedValue::LineCap(_) => todo!(),
			TaggedValue::LineJoin(_) => todo!(),
			TaggedValue::FillType(_) => todo!(),
			TaggedValue::GradientType(_) => todo!(),
			TaggedValue::GradientPositions(_) => todo!(),
			TaggedValue::Quantization(_) => todo!(),
			TaggedValue::OptionalColor(_) => todo!(),
			TaggedValue::ManipulatorGroupIds(_) => todo!(),
			TaggedValue::Font(_) => todo!(),
			TaggedValue::BrushStrokes(_) => todo!(),
			TaggedValue::BrushCache(_) => todo!(),
			TaggedValue::Segments(_) => todo!(),
			TaggedValue::DocumentNode(_) => todo!(),
			TaggedValue::GraphicGroup(_) => todo!(),
			TaggedValue::Artboard(_) => todo!(),
			TaggedValue::Artboards(_) => todo!(),
			TaggedValue::Curve(_) => todo!(),
			TaggedValue::IVec2(_) => todo!(),
			TaggedValue::SurfaceFrame(_) => todo!(),
			TaggedValue::Footprint(_) => todo!(),
			TaggedValue::RenderOutput(_) => todo!(),
			TaggedValue::Palette(_) => todo!(),
		}
	}
}
...
impl<'a> TaggedValue {
	...
	pub fn to_any(self) -> Any<'a> {
		match self {
			...
			TaggedValue::Artboards(x) => Box::new(x),
	...
	pub fn ty(&self) -> Type {
		match self {
			...
			TaggedValue::Artboards(_) => concrete!(graphene_core::Artboards),
