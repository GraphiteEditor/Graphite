...
impl Default for ProtoNode {
	fn default() -> Self {
		Self {
			identifier: ProtoNodeIdentifier::new("core_types::ops::IdentityNode"),
	...
	fn insert_context_nullification_node(&mut self, node_id: NodeId, context_deps: ContextFeatures) -> NodeId {
		...
		self.nodes.push((
			...
			ProtoNode {
				...
				call_argument: concrete!(Context),
				identifier: core_types::memo::memo::IDENTIFIER,
				original_location: OriginalLocation {
					path: path.clone(),
					..Default::default()
				},
		...
		self.nodes.push((
			...
			ProtoNode {
				...
				call_argument: concrete!(Context),
				identifier: gcore_nodes::context_modification::context_modification::IDENTIFIER,
				original_location: OriginalLocation {
					path: path.clone(),
					..Default::default()
				},
