...
pub struct DehazeImageNode<Scale> {
	scale: Scale,
}

#[node_macro::node_fn(DehazeImageNode)]
fn dehaze_image_node(image_frame: ImageFrame<Color>, scale: f64) -> ImageFrame<Color> {
	...
	let dehazed_dynamic_image = dehaze(dynamic_image, scale);
