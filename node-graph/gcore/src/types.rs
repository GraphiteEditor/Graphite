...
fn migrate_type_descriptor_names<'de, D: serde::Deserializer<'de>>(deserializer: D) -> Result<Cow<'static, str>, D::Error> {
	...
	let name = match name.as_str() {
		...
		"graphene_core::graphic_element::GraphicGroup" => "graphene_core::instances::Table<graphene_core::graphic_element::GraphicGroup>".to_string(),
		"graphene_core::vector::vector_data::VectorData" => "graphene_core::instances::Table<graphene_core::vector::vector_data::VectorData>".to_string(),
		...
		| "graphene_core::instances::Instances<graphene_core::raster::image::Image<graphene_core::raster::color::Color>>" => {
			"graphene_core::instances::Table<graphene_core::raster::image::Image<graphene_core::raster::color::Color>>".to_string()
		}
		_ => name,
	};
