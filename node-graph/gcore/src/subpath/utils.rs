// use super::consts::{MAX_ABSOLUTE_DIFFERENCE, STRICT_MAX_ABSOLUTE_DIFFERENCE};
// use super::*;
...
// pub fn compute_circular_subpath_details<PointId: crate::subpath::Identifier>(
// 	left: DVec2,
// 	arc_point: DVec2,
// 	right: DVec2,
// 	center: DVec2,
// 	angle: Option<f64>,
// ) -> (DVec2, ManipulatorGroup<PointId>, DVec2) {
