...
fn node_registry() -> HashMap<ProtoNodeIdentifier, HashMap<NodeIOTypes, NodeConstructor>> {
	let node_types: Vec<(ProtoNodeIdentifier, NodeConstructor, NodeIOTypes)> = vec![
		...
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::ArtboardGroup]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => String]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => glam::IVec2]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => glam::DVec2]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => bool]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => f64]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => u32]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => ()]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => Vec<f64>]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: Footprint, fn_params: [Footprint => Vec<f64>]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => BlendMode]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::vector::misc::BooleanOperation]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => Option<graphene_core::Color>]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::vector::style::Fill]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::vector::style::LineCap]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::vector::style::LineJoin]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::vector::style::Stroke]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::vector::style::Gradient]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::vector::style::GradientStops]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => Vec<graphene_core::uuid::NodeId>]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => graphene_core::Color]),
		async_node!(graphene_core::memo::MonitorNode<_, _, _>, input: (), fn_params: [() => Box<graphene_core::vector::VectorModification>]),
