...
fn node_registry() -> HashMap<ProtoNodeIdentifier, HashMap<NodeIOTypes, NodeConstructor>> {
	let mut node_types: Vec<(ProtoNodeIdentifier, NodeConstructor, NodeIOTypes)> = vec![
		...
		// CACHE NODES
		// ===========
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => ()]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => bool]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<Artboard>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<Graphic>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<Vector>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<Raster<CPU>>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<Color>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Image<Color>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<GradientStops>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<String>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<NodeId>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<f64>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<u8>]),
		#[cfg(target_family = "wasm")]
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => CanvasHandle]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => f64]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => f32]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => u32]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => u64]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => DVec2]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => String]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => DAffine2]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Footprint]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => RenderOutput]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => &PlatformEditorApi]),
		#[cfg(feature = "gpu")]
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<Raster<GPU>>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Option<f64>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Option<Color>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Graphic]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => glam::f32::Vec2]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => glam::f32::Affine2]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::Stroke]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::Gradient]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::text::Font]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Table<BrushStroke>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => BrushCache]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => DocumentNode]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::ContextFeatures]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::curve::Curve]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::transform::Footprint]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => Box<graphene_std::vector::VectorModification>]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::Fill]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::blending::BlendMode]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::LuminanceCalculation]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::QRCodeErrorCorrectionLevel]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::extract_xy::XY]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::text_nodes::StringCapitalization]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::RedGreenBlue]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::RedGreenBlueAlpha]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::animation::RealTimeMode]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::NoiseType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::FractalType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::CellularDistanceFunction]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::CellularReturnType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::DomainWarpType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::RelativeAbsolute]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::raster::SelectiveColorChoice]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::GridType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::ArcType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::RowsOrColumns]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::MergeByDistanceAlgorithm]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::ExtrudeJoiningAlgorithm]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::PointSpacingType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::StrokeCap]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::StrokeJoin]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::StrokeAlign]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::PaintOrder]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::FillType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::style::GradientType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::transform::ReferencePoint]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::CentroidType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::BooleanOperation]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::text::TextAlign]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::transform::ScaleType]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => graphene_std::vector::misc::InterpolationDistribution]),
		async_node!(graphene_core::memo::CacheNode<_, _>, input: Context, fn_params: [Context => RenderIntermediate]),
	];
	// =============
	// CONVERT NODES
	// =============
