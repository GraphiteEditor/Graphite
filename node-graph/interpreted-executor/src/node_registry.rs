...
fn node_registry() -> HashMap<NodeIdentifier, HashMap<NodeIOTypes, NodeConstructor>> {
	let node_types: Vec<Vec<(NodeIdentifier, NodeConstructor, NodeIOTypes)>> = vec![
		...
		register_node!(graphene_core::ops::AddNode, input: (u32, &u32), params: []),
		register_node!(graphene_core::ops::SubtractNode, input: (u32, u32), params: []),
		register_node!(graphene_core::ops::SubtractNode, input: (u32, &u32), params: []),
		register_node!(graphene_core::ops::DivideNode, input: (u32, u32), params: []),
		register_node!(graphene_core::ops::DivideNode, input: (u32, &u32), params: []),
		register_node!(graphene_core::ops::MultiplyNode, input: (u32, u32), params: []),
		register_node!(graphene_core::ops::MultiplyNode, input: (u32, &u32), params: []),
		register_node!(graphene_core::ops::ModuloNode, input: (u32, u32), params: []),
		register_node!(graphene_core::ops::ModuloNode, input: (u32, &u32), params: []),
