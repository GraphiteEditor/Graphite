...
fn node_registry() -> HashMap<ProtoNodeIdentifier, HashMap<NodeIOTypes, NodeConstructor>> {
	let node_types: Vec<Vec<(ProtoNodeIdentifier, NodeConstructor, NodeIOTypes)>> = vec![
		...
		async_node!(graphene_core::vector::AreaNode<_>, input: Footprint, output: f64, fn_params: [Footprint => VectorData]),
		async_node!(graphene_core::vector::CentroidNode<_, _>, input: Footprint, output: DVec2, fn_params: [Footprint => VectorData, () => graphene_core::vector::misc::CentroidType]),
