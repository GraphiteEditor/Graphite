...
fn node_registry() -> HashMap<NodeIdentifier, HashMap<NodeIOTypes, NodeConstructor>> {
	let node_types: Vec<Vec<(NodeIdentifier, NodeConstructor, NodeIOTypes)>> = vec![
		...
		register_node!(graphene_core::ConstructArtboardNode<_, _, _>, input: graphene_core::ArtboardGroup, params: [String, Option<[glam::IVec2;2]>, graphene_core::ArtboardGroup]),
		register_node!(graphene_core::ConstructArtboardNode<_, _, _>, input: graphene_core::GraphicGroup, params: [String, Option<[glam::IVec2;2]>, graphene_core::ArtboardGroup]),
	];
