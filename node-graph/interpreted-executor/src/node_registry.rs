...
fn node_registry() -> HashMap<NodeIdentifier, HashMap<NodeIOTypes, NodeConstructor>> {
	let node_types: Vec<Vec<(NodeIdentifier, NodeConstructor, NodeIOTypes)>> = vec![
		...
		register_node!(graphene_core::transform::FlipNode<_, _, _, _, _, _, _>, input: VectorData, params: [bool, bool, DVec2, f32, DVec2, DVec2, DVec2]),
		register_node!(graphene_core::transform::FlipNode<_, _, _, _, _, _, _>, input: ImageFrame<Color>, params: [bool, bool, DVec2, f32, DVec2, DVec2, DVec2]),
		register_node!(graphene_core::transform::FlipNode<_, _, _, _, _, _, _>, input: WasmSurfaceHandleFrame, params: [bool, bool, DVec2, f32, DVec2, DVec2, DVec2]),
