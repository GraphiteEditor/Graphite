...
fn construct_color_rgba(_: impl Ctx, _primary: (), red: f32, green: f32, blue: f32, alpha: f32) -> Color {
	Color::from_rgbaf32_unchecked(red.clamp(0.0, 1.0), green.clamp(0.0, 1.0), blue.clamp(0.0, 1.0), alpha.clamp(0.0, 1.0))
}
...
fn construct_color_hsla(_: impl Ctx, _primary: (), hue: f32, saturation: f32, lightness: f32, alpha: f32) -> Color {
	Color::from_hsla(hue.clamp(0.0, 1.0), saturation.clamp(0.0, 1.0), lightness.clamp(0.0, 1.0), alpha.clamp(0.0, 1.0))
}
...
fn construct_color_grayscale(_: impl Ctx, _primary: (), luminance: f32) -> Color {
	Color::from_luminance(luminance.clamp(0.0, 1.0))
}
...
fn construct_color_cmyka(_: impl Ctx, _primary: (), cyan: f32, magenta: f32, yellow: f32, key: f32, alpha: f32) -> Color {
	Color::from_cmyka(cyan.clamp(0.0, 1.0), magenta.clamp(0.0, 1.0), yellow.clamp(0.0, 1.0), key.clamp(0.0, 1.0), alpha.clamp(0.0, 1.0))
}
