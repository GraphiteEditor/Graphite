...
impl JsEditorHandle {
	...
	pub fn set_imaginate_blob_url(&self, _document_id: u64, _layer_path: Vec<LayerId>, _blob_url: String, _width: f64, _height: f64) {
		// let resolution = (width, height);
	...
	pub fn set_imaginate_generating_status(&self, _document_id: u64, _path: Vec<LayerId>, _percent: Option<f64>, _status: String) {
