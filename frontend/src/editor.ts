...
import type { FrontendMessage, FrontendMessages } from "@graphite/messages";
...
export function createEditor(): Editor {
	...
	const handle = EditorHandle.create(operatingSystem(), randomSeed, (messageType: keyof FrontendMessages, messageData: FrontendMessage) => {
