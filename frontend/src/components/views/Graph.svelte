<script lang="ts">
	...
	function dataTypeTooltip(value: FrontendGraphInputOld | FrontendGraphOutputOld): string {
	...
	function outputConnectedToText(output: FrontendGraphOutputOld): string {
...
{#if $nodeGraph.renderNativeNodeGraphOld}
	...
	<!-- Layers and nodes -->
	<div class="layers-and-nodes" style:transform-origin="0 0" style:transform={`translate(${$nodeGraph.transformOld.x}px, ${$nodeGraph.transformOld.y}px) scale(${$nodeGraph.transformOld.scale})`}>
		<!-- Layers -->
