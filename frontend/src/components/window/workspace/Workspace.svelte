<script lang="ts">
	import DialogModal from "~/src/components/floating-menus/DialogModal.svelte";
	import LayoutCol from "~/src/components/layout/LayoutCol.svelte";
	import LayoutRow from "~/src/components/layout/LayoutRow.svelte";
	import Panel from "~/src/components/window/workspace/Panel.svelte";
	import { getContext } from "svelte";
	import type { Editor } from "~/src/wasm-communication/editor";
	import type { WorkspaceState } from "~/src/state-providers/workspace";
	import type { PortfolioState } from "~/src/state-providers/portfolio";
	import type { DialogState } from "~/src/state-providers/dialog";
	import type { FrontendDocumentDetails } from "~/src/wasm-communication/messages";
