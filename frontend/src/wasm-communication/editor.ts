...
import { TauriHandle, subscriptions } from "@/wasm-communication/tauri-editor";

//export type WasmRawInstance = typeof WasmBindgenPackage;
export type WasmEditorInstance = TauriHandle;
export type Editor = Readonly<ReturnType<typeof createEditor>>;

// `wasmImport` starts uninitialized because its initialization needs to occur asynchronously, and thus needs to occur by manually calling and awaiting `initWasm()`
let wasmImport: TauriHandle | undefined;
...
export function createEditor() {
	...
	const instance: WasmEditorInstance = wasmImport/*new raw.JsEditorHandle((messageType: JsMessageType, messageData: Record<string, unknown>): void => {
