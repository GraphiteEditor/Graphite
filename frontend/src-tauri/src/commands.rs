...
#[tauri::command]
pub fn init_after_frontend_ready(platform: String) {
	...
	dispatch(GlobalsMessage::SetPlatform { platform });
	dispatch(Message::Init);
}

/// Displays a dialog with an error message
#[tauri::command]
pub fn error_dialog(title: String, description: String) {
...
#[tauri::command]
#[specta::specta]
pub fn update_layout(layout_target: LayoutTarget, widget_id: u64, value: serde_json::Value) -> Result<(), String> {
...
#[tauri::command]
pub fn load_preferences(preferences: String) {
...
#[tauri::command]
pub fn open_document_file(document_name: String, document_serialized_content: String) {
...
#[tauri::command]
pub fn open_auto_saved_document(document_id: u64, document_name: String, document_is_saved: bool, document_serialized_content: String) {
...
#[tauri::command]
pub fn trigger_auto_save(document_id: u64) {
	let message = PortfolioMessage::AutoSaveDocument { document_id };
	dispatch(message);
}

#[tauri::command]
pub fn close_document_with_confirmation(document_id: u64) {
	let message = PortfolioMessage::CloseDocumentWithConfirmation { document_id };
	dispatch(message);
}

#[tauri::command]
pub fn request_about_graphite_dialog_with_localized_commit_date(localized_commit_date: String) {
...
#[tauri::command]
pub fn on_wheel_scroll(x: f64, y: f64, mouse_keys: u8, wheel_delta_x: i32, wheel_delta_y: i32, wheel_delta_z: i32, modifiers: u8) {
...
#[tauri::command]
pub fn on_change_text(new_text: String) -> Result<(), String> {
...
#[tauri::command]
pub fn on_font_load(font_family: String, font_style: String, preview_url: String, data: Vec<u8>, is_default: bool) -> Result<(), String> {
...
#[tauri::command]
pub fn update_bounds(new_text: String) -> Result<(), String> {
...
#[tauri::command]
pub fn eyedropper_sample_for_color_picker() -> Result<(), String> {
...
#[tauri::command]
pub fn update_primary_color(red: f32, green: f32, blue: f32, alpha: f32) -> Result<(), String> {
...
#[tauri::command]
pub fn update_secondary_color(red: f32, green: f32, blue: f32, alpha: f32) -> Result<(), String> {
...
#[tauri::command]
pub fn paste_serialized_data(data: String) {
...
#[tauri::command]
pub fn select_layer(layer_path: Vec<LayerId>, ctrl: bool, shift: bool) {
...
#[tauri::command]
pub fn move_layer_in_tree(folder_path: Vec<LayerId>, insert_index: isize) {
...
#[tauri::command]
pub fn set_layer_name(layer_path: Vec<LayerId>, name: String) {
...
#[tauri::command]
pub fn set_image_blob_url(document_id: u64, layer_path: Vec<LayerId>, blob_url: String, width: f64, height: f64) {
...
#[tauri::command]
pub fn set_imaginate_image_data(document_id: u64, layer_path: Vec<LayerId>, node_path: Vec<NodeId>, image_data: Vec<u8>, width: u32, height: u32) {
...
#[tauri::command]
pub fn set_imaginate_generating_status(document_id: u64, layer_path: Vec<LayerId>, node_path: Vec<NodeId>, percent: Option<f64>, status: String) {
...
#[tauri::command]
pub fn set_imaginate_server_status(available: bool) {
...
/// Sends the blob URL generated by JS to the Imaginate layer in the respective document
#[tauri::command]
pub fn process_node_graph_frame(document_id: u64, layer_path: Vec<LayerId>, image_data: Vec<u8>, width: u32, height: u32, imaginate_node: Option<Vec<NodeId>>) {
...
#[tauri::command]
pub fn connect_nodes_by_link(output_node: u64, output_node_connector_index: usize, input_node: u64, input_node_connector_index: usize) {
...
#[tauri::command]
pub fn disconnect_nodes(node_id: u64, input_index: usize) {
...
#[tauri::command]
pub fn create_node(node_type: String, x: i32, y: i32) {
...
#[tauri::command]
pub fn select_nodes(nodes: Vec<u64>) {
...
#[tauri::command]
pub fn paste_serialized_nodes(serialized_nodes: String) {
...
#[tauri::command]
pub fn double_click_node(node: u64) {
...
#[tauri::command]
pub fn move_selected_nodes(displacement_x: i32, displacement_y: i32) {
...
#[tauri::command]
pub fn toggle_preview(node_id: NodeId) {
...
/// Pastes an image
#[tauri::command]
pub fn paste_image(image_data: Vec<u8>, width: u32, height: u32, mouse_x: Option<f64>, mouse_y: Option<f64>) {
...
#[tauri::command]
pub fn toggle_layer_visibility(layer_path: Vec<LayerId>) {
...
#[tauri::command]
pub fn toggle_layer_expansion(layer_path: Vec<LayerId>) {
