...
#[tauri::command]
#[specta::specta]
pub fn update_layout(layout_target: LayoutTarget, widget_id: Uuid, value: String) -> Result<Vec<FrontendMessage>, String> {
	log::debug!("{}", value);
...
#[tauri::command]
#[specta::specta]
pub fn select_document(document_id: Uuid) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn open_auto_saved_document(document_id: Uuid, document_name: String, document_is_saved: bool, document_serialized_content: String) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn trigger_auto_save(document_id: Uuid) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn close_document_with_confirmation(document_id: Uuid) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn set_image_blob_url(document_id: Uuid, layer_path: Vec<LayerId>, blob_url: String, width: f64, height: f64) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn set_imaginate_image_data(document_id: Uuid, layer_path: Vec<LayerId>, node_path: Vec<NodeId>, image_data: Vec<u8>, width: u32, height: u32) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn set_imaginate_generating_status(document_id: Uuid, layer_path: Vec<LayerId>, node_path: Vec<NodeId>, percent: Option<f64>, status: String) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn process_node_graph_frame(document_id: Uuid, layer_path: Vec<LayerId>, image_data: Vec<u8>, width: u32, height: u32, imaginate_node: Option<Vec<NodeId>>) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn shift_node(node_id: Uuid) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn select_nodes(nodes: Vec<Uuid>) -> Vec<FrontendMessage> {
...
#[tauri::command]
#[specta::specta]
pub fn double_click_node(node: Uuid) -> Vec<FrontendMessage> {
